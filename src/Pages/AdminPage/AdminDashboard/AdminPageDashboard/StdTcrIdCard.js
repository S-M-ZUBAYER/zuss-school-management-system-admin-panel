...
const StdTcrIdCard = () => {
    ...
    const handleTcrStaffImageSelect = (e) => {
        const file = e.target.files[0];
        if (file) {
            const imageUrl = URL.createObjectURL(file);
    ...
    return (
        <div>
                        ...
                        <div className="mx-3 my-5">
                            <form onSubmit={handleSubmitStudent}>
                                ...
                                <input
                                    ...
                                    className="w-full bg-black pl-2 text-white"
                                />
                                ...
                                <input type="email" className="w-full bg-black pl-2 text-white" placeholder="please provide student Phone No" id="stdPhone" value={stdPhone} onChange={handleToStdPhone} />
                                <hr className="border-slate-300 mb-8 mx-1"></hr>
            ...
            <h1 className="text-2xl text-lime-800 font-bold my-5 mt-20">
                Teacher & Staff Id Card Section
            </h1>
            <div className=" text-center grid lg:grid-cols-3 text-white my-20">
                <div>
                    <div>
                        <h1 className="text-xl font-bold text-yellow-200 mb-3">
                        ...
                        <h1>
                            Please provide Teacher or Staff information to generate Teacher Or Staff id card
                        </h1>
                    </div>
                            ...
                            <div className="mx-3 my-5">
                                <form onSubmit={handleSubmitTeacher}>
                                    <input
                                        type="file"
                                        accept="image/*" // Accept only image files
                                        onChange={handleTcrStaffImageSelect}
                                        className="w-full bg-black pl-2 text-white"
                                    />
                                    <hr className="border-slate-300 mb-8 mx-1"></hr>

                                    <input type="text" className="w-full bg-black pl-2 text-white" placeholder="please provide  name" id="TeacherName" value={teacherName} onChange={handleToTeacherName} />
                                    <hr className="border-slate-300 mb-8 mx-1"></hr>
                                    ...
                                    <input type="text" className="w-full bg-black pl-2 text-white" placeholder="please provide designation" id="TeacherDesignation" value={teacherDesignation} onChange={handleToTeacherDesignation} />
                                    <hr className="border-slate-300 mb-8 mx-1"></hr>
                ...
                <div className="  lg:col-span-2 lg:grid grid-cols-2 mx-auto">
                    <TeacherIdCard1
                        schoolName={schoolName}
                        selectedStaffImage={selectedStaffImage}
                        name={teacherName}
                        img={teacherImg}
                        email={teacherEmail}
                        id={teacherId}
