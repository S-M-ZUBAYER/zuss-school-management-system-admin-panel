...
const TeacherIdCard2 = ({ name, email, id, stdClass, gender, designation, expire, cardIssue, dateOfBirth, img, selectedStaffImage }) => {
    const { schoolName } = useContext(AuthContext)
    return (
        <div className="mb-10 w-80 h-56 bg-white shadow-md rounded-md overflow-hidden" style={{ backgroundImage: `url(${img2})` }}>
